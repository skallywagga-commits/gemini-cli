...
describe('PolicyEngine', () => {
  ...
  describe('MCP server wildcard patterns', () => {
    it('should match MCP server wildcard patterns', () => {
      const rules: PolicyRule[] = [
        { toolName: 'my-server__*', decision: PolicyDecision.ALLOW, priority: 10 },
        { toolName: 'blocked-server__*', decision: PolicyDecision.DENY, priority: 20 },
      ];
    ...
    it('should prioritize specific tool rules over server wildcards', () => {
      const rules: PolicyRule[] = [
        { toolName: 'my-server__*', decision: PolicyDecision.ALLOW, priority: 10 },
        { toolName: 'my-server__dangerous-tool', decision: PolicyDecision.DENY, priority: 20 },
      ];
